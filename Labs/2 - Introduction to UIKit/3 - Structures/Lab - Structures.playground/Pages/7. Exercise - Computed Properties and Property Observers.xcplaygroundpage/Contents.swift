...
struct Height {
    var heightInInches: Double {
        didSet {
            ...
            print("Old value: \(oldValue) which has been updated to \(heightInInches)")
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            ...
            print("Old value: \(oldValue) which has been updated to \(heightInCentimeters)")
        }
    }

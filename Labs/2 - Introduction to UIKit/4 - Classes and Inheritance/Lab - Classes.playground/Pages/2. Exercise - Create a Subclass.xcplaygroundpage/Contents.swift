...
print("The code doesn't work because 'weapon' is a property of the the 'Fighter' class and is not available to the parent class 'Spaceship' whereas properties of the parent class 'Spaceship' are availabkle to the child class 'Fighter'.")

...
var friends: [String] = ["Aaradhya", "Jasmine","Daman", "Janvhi", "Disha"]
let sortedCollection1 = friends.sorted(by: forwards)
...
let sortedCollection2 = friends.sorted{ (name1: String, name2: String) -> Bool in
    if name1 < name2 {
        return true
    } else {
        return false
...
let sortedCollection3 = friends.sorted(by: {$0 < $1})

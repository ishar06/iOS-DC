...
let firstRunningWorkout = RunningWorkout(distance: 4, time: 2)
let firstSwimmingWorkout = SwimmingWorkout(distance: 5, time: 1)
simpleWorkoutDescription(workout: firstRunningWorkout)
simpleWorkoutDescription(workout: firstSwimmingWorkout)
